...
def webhook():
    ...
    return {}
	elif (intent_name == "Station_search"):
        return search(req)
    return {}
	elif (intent_name == "Name_to_code"):
        return nametocode(req)
    return {}
	elif (intent_name == "Code_to_name"):
        return codetoname(req)
    return {}
	elif (intent_name == "Pnr_Number"):
		return pnrnumber(req)
	return {}
	elif (intent_name == "Fog_Affected_Train")
		return fogtrain(req)
	return {}


# this func is for train info
def traininfo(data):
...
# this func is for location on map
...
# this func is for viewing location of the train	
def search(data):
    # getting the action from the request json
    action = data["queryResult"]["action"]
...
# this func is for sending current loc of train to dialogflow
...
# this func is for converting name to code
	def nametocode(data):
    #getting the action from the request json
    action = data["queryResult"]["action"]
	#getting station name
